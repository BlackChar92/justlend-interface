...
class RecommendToken extends React.Component {
  ...
  closeRecommend = () => {
    window.gtag('event', 'PC_close_recommend', { 'event_category': 'PC_V1.5', 'event_label': 'close_recommend' });
  ...
  recommendToken = () => {
    ...
    let { balanceInfo, marketDataSource, assetList } = this.props.market;
    const { isShowRecommendToken, isUserSunOldEmpty } = this.props.user;
