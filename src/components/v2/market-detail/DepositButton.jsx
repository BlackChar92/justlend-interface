      ...
      <>
        {this.props.lend.serviceInnerStatus === 'disabled' ? (
          ...
          <Tooltip
                  ...
                  <span
                    ...
                    onClick={() => {
                      if (!isConnected) {
                        ...
                        this.props.lend.setActiveKey('supply');
                      } else {
                        if (isM) {
                          window.location.href =
                            window.location.origin + `/homeNew?lang=${lang}&activeKey=supply#scrollToMobileTab`;
                        } else {
            ...
            arrowPointAtCenter
            overlayClassName={
              'j-tooltip-dropdown light mobile-l-30' +
              (this.props.market?.DAWPop?.show && ['BUSD', 'ETH'].includes(item?.collateralSymbol) && isM
          ...
          >
            <button
              ...
              onClick={e => {
                e.preventDefault();
                e.stopPropagation();
                window.gtag('event', 'market-detail-new-deposit', {
