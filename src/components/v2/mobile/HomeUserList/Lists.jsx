...
class Lists extends React.Component {
  ...
  scrollTop = (bool, type) => {
    ...
    if (type === 'isShowMoreV2') {
      this.props.ui.toggleShowMoreV2();
    } else if (type === 'isDepositShowMore') {
      this.props.ui.toggleDepositShowMore();
    } else if (type === 'isLendShowMore') {
      this.props.ui.toggleLendShowMore();
    }
  };

  render() {
    const { isLendShowMore, isDepositShowMore, isShowMoreV2 } = this.props.ui;
    const { theme, activeKey: activeKeyLend } = this.props.lend;
    ...
    return (
      <>
        {depositNum > 0 && (
          <div className="j-home-records" id="mobile-my-position">
