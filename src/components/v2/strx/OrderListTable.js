...
import { BigNumber, cutMiddle, emptyReactNodeNew, formatNumber, transferTime } from '../../../utils/helper';
          ...
          title={
            <div className="rent-info-tooltip">
              <div className="detail-row">
                <div className="row-title2">{intl.get('energy_rental.end_order_modal.remaining_trx')}</div>
          ...
          ({ canRentSeconds, delegateTrxAmount, energyAmount, receiver, renter, startTimestamp }, i) => (
            <div className="mobile-card" key={i}>
              ...
              <div className="field">
                <div className="title">
                  <span className="flex-box">
                    {isExpiryTime ? intl.get('strx.expiry_time') : intl.get('strx.remaining_period')}
                    <span className="switch-icon" onClick={this.toggleIsExpiryTime} />
                  </span>
                </div>
