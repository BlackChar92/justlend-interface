...
class EnergyRent extends React.Component {
  ...
  componentDidMount = async () => {
    window.location.href = window.location.origin + `/energyRental?lang=${this.state.lang}`;
          ...
          <Tooltip
            ...
            onMouseEnter={() => {
              try {
                ...
                console.error('tooltip position failed:', error);
              }
            }}
          >
  ...
  rentInfoNotLogin = () => {
    ...
    return (
      ...
      <div className={'my-rent-info not-login-info'}>
        {/* <div className={'rent-top-bg' + (lang === 'en-US' ? ' en' : lang === 'zh-TC' ? ' tc' : '')}></div> */}
        <div className="rent-info-top">
          <div className="rent-info-content">
            <div className="rent-info-title">
              {intl.get('strx.energy_rent_10w_per_day')}
              {/* <span>{intl.get('strx.energy_subsidy_after')}</span> */}
            </div>
            <div className="rent-energy-amount">
              <span className="equal-alike">{'≈ '}</span>
              <span className="rent-amount">
                {formatNumber(BigNumber(marketData.trx1wEnergy).times(10), 3, { miniText: '0.001' })}
              </span>{' '}
              <span className="rent-unit">TRX/{intl.get('strx.energy_day2')}</span>
            </div>
          </div>
          ...
          <div className="j-select-alike j-select-alike-energy">
            ...
            >
              <span
                ...
                onMouseEnter={() => {
                  let v = type === '1' ? '1' : '';
                  window.gtag('event', 'energy_rent_hover' + v, {
                    'event_category': 'sTRX',
              ...
              <div className="top-header">
                <div className="flexA">
                  ...
                  <Link
                    ...
                    onClick={() => {
                      window.gtag('event', 'energyrent_old_click_swicthtoPro', {
