...
class VoteDetailModal extends React.Component {
  ...
  renderVoting = (data, canRetrieve = false) => {
    const { voteSourceData } = this.props.vote;
  ...
  render() {
    ...
    const { userCanRedeemVoteList, userVotingVote, voteDetailModalVisible, userCanRedeemVoteNum } = this.props.vote;
    ...
    return (
      <Modal
        ...
        onCancel={() => {
          this.props.system.clearRejectError();
          this.props.vote.setVoteDetailModalVisible(false);
