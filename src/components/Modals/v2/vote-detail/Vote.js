...
class Vote extends React.Component {
  ...
  hideVoteForPop = () => {
    ...
    this.props.lend.setData({ voteForPop: false });
  };
  ...
  getVote = () => {
    ...
    this.props.lend.setData({ swapJstToVoteModalVisible: true });
  ...
  vote = async () => {
    ...
    const { lockNum, voteForPopIsFor, voteForPopProposalId } = this.props.lend;
    ...
    try {
      ...
      if (txID) {
        ...
        this.hideVoteForPop();
        setTimeout(() => {
          this.props.lend.getVoteDetail(voteForPopProposalId);
        }, 5000);
      } else {
        this.setState({
          isSigning: false
