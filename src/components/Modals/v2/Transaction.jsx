...
class Transaction extends React.Component {
  ...
  render() {
    ...
    const amount = formatNumber(obj?.value, 3, {
      miniText: 0.001
    });
        ...
        >
          <div className="trans-title">
            {transType === 'approve'
              ...
              : step === 10
              ? intl.get('vote.approve_faild', obj)
              : step === 82
          ...
          <div className="trans-body center">
              ...
              <React.Fragment key="step2">
                ...
                <div className="trans-tips">
                  ...
                  {transType === 'returnResourceNew' &&
                    intl.getHTML('energy_rental.end_order_modal.transaction_finished_msg', {
                      value: obj?.value
                    })}
            ...
            {step == 83 ? (
              <React.Fragment key="step2">
                ...
                <div>
                  <span className="hover">
                    {tronscanTX(intl.get('v2.tip34'), txId, () =>
                      window.gtag('event', 'energyrent_pro_endtx_successpop_goScan', {
                        'event_category': 'energyrent',
            ...
            {step === 10 ? (
              <React.Fragment key="step3">
                ...
                <div className="trans-tips">{intl.get('vote.approve_faild')}</div>
                <button
                  className="j-large-btn loading-close"
                  onClick={() => {
                    this.props.system.hideTransModal();
