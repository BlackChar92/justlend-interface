...
class RenewFormStep extends React.Component {
  ...
  render() {
    ...
    // console.log('=============================================');
    // console.log('renewOrderExistingEnergyAmount: ' + renewOrderExistingEnergyAmount);
    // console.log('renewOrderExistingRemainingSeconds: ' + renewOrderExistingRemainingSeconds);
    // console.log('renewOrderEnergyAmount: ' + renewOrderEnergyAmount);
    // console.log('renewOrderDuration: ' + renewOrderDuration);
    // console.log('renewOrderPrepayment: ' + renewOrderPrepayment);
    // console.log('renewOrderSecurityDeposit: ' + renewOrderSecurityDeposit);
    // console.log('haveAnyInputError: ' + haveAnyInputError);
    // console.log('formEnergyAmount: ' + formEnergyAmount);
    // console.log('renewOrderEnergyAmount: ' + renewOrderEnergyAmount);
    // console.log('durationValueInSeconds: ' + durationValueInSeconds);
    // console.log('renewOrderDuration: ' + renewOrderDuration);
    // console.log('isRenewOrderInfoUpdated: ' + isRenewOrderInfoUpdated);
