  ...
  render() {
    ...
    return (
      <Modal
        ...
        onCancel={() => this.props.lend.setData({ openCollateralShow: false })}
      ...
      >
        ...
        <button className="j-large-btn j-supply" onClick={() => this.props.lend.setData({ openCollateralShow: false })}>
