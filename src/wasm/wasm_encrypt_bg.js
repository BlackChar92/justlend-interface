 ...
 * @returns {string}
 */
export function encrypt_with_type_env(type_, env, data) {
  let deferred4_0;
  let deferred4_1;
  try {
    ...
    const ret = wasm.encrypt_with_type_env(ptr0, len0, ptr1, len1, ptr2, len2);
    deferred4_0 = ret[0];
    deferred4_1 = ret[1];
 ...
 * @returns {string}
 */
export function encrypt_with_public_key(public_key_pem, data) {
  let deferred3_0;
  let deferred3_1;
  try {
    ...
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.encrypt_with_public_key(ptr0, len0, ptr1, len1);
    deferred3_0 = ret[0];
    deferred3_1 = ret[1];
    return getStringFromWasm0(ret[0], ret[1]);
  } finally {
...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === 'undefined') {
    module_or_path = new URL('wasm_encrypt_bg.wasm', import.meta.url);
  }
  const imports = __wbg_get_imports();
